            ...
            <div class="card rounded">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <div><img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no-image.jpg')}}" alt="profile">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.update.password') }}" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputName1" class="form-label">Confirm New Password</label>
